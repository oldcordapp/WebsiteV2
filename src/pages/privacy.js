      ...
      <div className={styles.header}>
        <div className={styles["tagline-container"]}>
          ...
          <div className={`${styles["tagline-subtitle"]} text-light-gray`}>
            Last Updated: September 9th, 2024 | Effective: September 10th, 2024
          </div>
        </div>
      </div>
        ...
        <div className={sectionStyles["section-content"]}>
          ...
          <ul>
            <li className={sectionStyles.text}>
              <span className={sectionStyles.bold}>Email Address: </span>Used for
            ...
            <li className={sectionStyles.text}>
              <span className={sectionStyles.bold}>Password: </span>Stored in a hashed
              and salted format for security.
            </li>
            <li className={sectionStyles.text}>
              <span className={sectionStyles.bold}>User ID: </span>A randomly generated
              identifier unique to your account.
            </li>
            <li className={sectionStyles.text}>
              <span className={sectionStyles.bold}>IP Address: </span>Recorded upon
          ...
          <span className={sectionStyles.title}>Information We Do Not Collect</span>
          <span className={sectionStyles.text}>We do not collect or store:</span>
          <ul>
          ...
          <span className={sectionStyles.title}>How We Use Your Information</span>
          <span className={sectionStyles.text}>
            We use your information solely for the following purposes:
          </span>
          <ul>
            <li className={sectionStyles.text}>To create and manage your account</li>
            <li className={sectionStyles.text}>
          ...
          <span className={sectionStyles.title}>Data Retention and Deletion</span>
          <span className={sectionStyles.text}>
          ...
          <ul>
            <li className={sectionStyles.text}>
              <span className={sectionStyles.bold}>Email: </span>contact@noia.site
            </li>
            <li className={sectionStyles.text}>
              <span className={sectionStyles.bold}>Direct Message: </span>You can also
          ...
          <span className={sectionStyles.title}>Changes to This Privacy Policy</span>
          <span className={sectionStyles.text}>
