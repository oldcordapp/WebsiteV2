        ...
        <div className={sectionStyles["section-content"]}>
          ...
          <ul>
            <li className={sectionStyles.text}>
              <span className={sectionStyles.bold}>"We," "Us," and "Our"</span> refers
              to Oldcord.
            </li>
            <li className={sectionStyles.text}>
              <span className={sectionStyles.bold}>"Code"</span> refers to the
              open-source code of Oldcord, licensed under GPL 3.0.
            </li>
            <li className={sectionStyles.text}>
              <span className={sectionStyles.bold}>"Instance"</span> refers to our
              hosted version of Oldcord.
            </li>
            <li className={sectionStyles.text}>
              <span className={sectionStyles.bold}>"Services"</span> refers to both the
              Code and the Instance.
            </li>
            <li className={sectionStyles.text}>
              <span className={sectionStyles.bold}>"You" and "Your"</span> refers to
          ...
          <span className={sectionStyles.title}>Instance/Code "AS IS"</span>
          <span className={sectionStyles.text}>
