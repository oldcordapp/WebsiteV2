          ...
          <div className={styles["upsell-section-content"]}>
            <div>
              ...
              <span className={styles["upsell-small-print"]}>
                *Clients from a certain instant messaging service are not open
                source. They are downloaded and launched in the browser by the
                bootstraper, with modifications for QoL features and bug fixes.
                We reverse-engineered the API and websocket responses using
                publicly available sources. The server code does not include any
                code from that service.
              </span>
            </div>
